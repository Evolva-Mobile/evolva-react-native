...
import ImageShop from '@/assets/images/components/tabs/shopping-basket.png'
...
import ShopScreen from '@/src/screens/journey/shop';
...
export default function TabsJorney({ journey }: TabsJourneyProps) {
    ...
    return (
        ...
        <>
            ...
            {isMaster && (<FloatingMenu journey={journey}/>)}
        </>
    );
}
